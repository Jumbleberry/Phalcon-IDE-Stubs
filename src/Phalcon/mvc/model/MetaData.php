...
abstract class MetaData implements \Phalcon\Di\InjectionAwareInterface, \Phalcon\Mvc\Model\MetaDataInterface
{
     ...
     * @return void
     */
    public function setStrategy(\Phalcon\Mvc\Model\MetaData\StrategyInterface $strategy): void
    {
    }
     ...
     * @return void
     */
    public final function writeMetaDataIndex(\Phalcon\Mvc\ModelInterface $model, int $index, $data): void
    {
    }
